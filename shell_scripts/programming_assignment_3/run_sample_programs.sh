...
python3 code_generator.py sample_programs/programming_assignment_3/Program1.csvlang

echo "Generating Code for Sample Program 2"
python3 code_generator.py sample_programs/programming_assignment_3/Program2.csvlang

echo "Generating Code foring Sample Program 3"
python3 code_generator.py sample_programs/programming_assignment_3/Program3.csvlang

echo "Generating Code for Sample Program 4"
python3 code_generator.py sample_programs/programming_assignment_3/Program4.csvlang

echo "Generating Code for Sample Program 5"
python3 code_generator.py sample_programs/programming_assignment_3/Program5.csvlang
