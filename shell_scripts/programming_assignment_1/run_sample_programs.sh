...
python3 ../../scanner.py ../../sample_programs/programming_assignment_1/Program1.csvlang

echo "Lexing Sample Program 2"
python3 ../../scanner.py ../../sample_programs/programming_assignment_1/Program2.csvlang

echo "Lexing Sample Program 3"
python3 ../../scanner.py ../../sample_programs/programming_assignment_1/Program3.csvlang

echo "Lexing Sample Program 4"
python3 ../../scanner.py ../../sample_programs/programming_assignment_1/Program4.csvlang

echo "Lexing Sample Program 5"
python3 ../../scanner.py ../../sample_programs/programming_assignment_1/Program5.csvlang
